...
impl Instruction {
    ...
    fn decode_extended(word: u32) -> Result<(InstructionType, SmallVec<[Operand; 4]>)> {
        ...
        let rs: u8 = ((word >> 21) & 0x1F) as u8;
        let rt: u8 = ((word >> 21) & 0x1F) as u8;
        let _rc: bool = (word & 1) != 0; // Record bit (update condition register)
        ...
        match extended_opcode {
            ...
            // Note: addmeo (234) and addzeo (202) overflow variants share the same
            // extended opcode as addme/addze — handled above.
            ...
            // Note: subfzeo (74) and subfmeo (106) overflow variants share the same
            // extended opcode as subfze/subfme — handled above.
            ...
            // Extended opcode 32: cmplw (opcode 31) or fsqrt (opcode 63)
            32 => {
                if (word >> 26) == 63 {
            ...
            // Note: fsqrt (extended opcode 32, opcode 63) is handled in the `32 =>` arm above.
